// dish catalog with category / veg / bestseller flags used by the
// search & filter bar and the customization modal on the Home page
const Cardsdata = [
    {
        id: 1,
